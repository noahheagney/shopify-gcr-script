...
type ExtractedInputFromRenderExtension<T> = T extends RenderExtension<infer Input, any> ? Input : never;
 ...
 */
export type InputForRenderExtension<ID extends keyof RenderExtensions> = ExtractedInputFromRenderExtension<RenderExtensions[ID]>;
/**
